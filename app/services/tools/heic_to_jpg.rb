...
module Tools
  class HeicToJpg < BaseTool
    protected

    def process(input_paths)
      if input_paths.size > 1
        raise ExecutionError, "This tool only accepts a single HEIC image at a time."
      end
      ...
      begin
        ...
        raise ExecutionError, "Failed to convert HEIC to JPG. #{e.message}"
      end
